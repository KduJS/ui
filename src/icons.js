const icons = require.context('../node_modules/@nkduy/md-icons-svg/svg/', true, /materialicons\/24px\.svg$/)
...
export function generateHtmlIcon (icon) {
  return `<div class="kdu-ui-icon"><svg><use href="#ic_${icon}_standard"></use></svg></div>`
}
